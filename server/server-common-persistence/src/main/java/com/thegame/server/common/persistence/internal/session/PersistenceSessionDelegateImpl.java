...
public abstract class PersistenceSessionDelegateImpl implements PersistenceSession{
	...
	private final static LogStream logger=LogStream.getLogger(PersistenceSessionDelegateImpl.class);
	...
	public PersistenceSessionDelegateImpl(final EntityManager _session){
		...
		logger.trace("persistence-session-delegate::create::persistence-session::{}",this.session);
	}
	...
	public String toString() {
		return MessageFormat.format("PersistenceSessionDelegateImpl[session={0}]",session);
	}	
}
